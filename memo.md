...
| ENV-500-00 | 500 | envファイルの読み込みに失敗しました |
| SRV-500-00 |500| サーバーの起動に失敗しました |
| SRV-500-01 |500| サーバーのシャットダウンに失敗しました |
| DB-500-00 | 500 | データベースへの接続に失敗しました |
